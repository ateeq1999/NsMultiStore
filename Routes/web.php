...
Route::middleware([ CheckMigrationStatus::class ])->group( function() {
    Route::get( '/dashboard/multistore/dashboard', [ MultiStoreController::class, 'home' ])->name( 'ns.multistore-dashboard' );
